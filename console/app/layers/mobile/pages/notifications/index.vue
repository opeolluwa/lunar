<template>
  <k-page>
    ...
    >
      <template #icon> <demo-icon /> </template>
    </k-notification>
    <k-notification
    ...
    >
      <template #icon> <demo-icon /> </template> <template #button />
    </k-notification>
    <k-notification
    ...
    >
      <template #title>Konsta UI</template> Notification closed
      <template #buttons>
...
export default {
  ...
  setup() {
    ...
    return { opened, alertOpened, openNotification };
  },
};
</script>
